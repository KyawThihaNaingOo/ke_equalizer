  ...
  private func resolveAudioURL(type: String, value: String) throws -> URL {
    ...
    case "asset":
      ...
      let candidates: [String?] = [
        ...
        Bundle.main.bundleURL.appendingPathComponent(lookupKey).path,
        Bundle.main.bundleURL.appendingPathComponent("flutter_assets/\(lookupKey)").path,
        Bundle.main.bundleURL.appendingPathComponent("flutter_assets/\(value)").path,
        Bundle.main.path(forResource: lookupKey, ofType: nil),
        Bundle.main.path(forResource: value, ofType: nil),
      ]
  ...
  private func schedulePlaybackLoop() {
    ...
    player.scheduleFile(file, at: nil) { [weak self] in
      DispatchQueue.main.async {
        guard let self = self, self.shouldLoopPlayback else { return }
